...
class Result extends Component<ResultProps> {
  public render() {
    ...
    return <li
        ...
        <button onClick={this.props.pinResult.bind(this, this.props.result)} className="action"><svg viewBox="0 0 32 32" aria-hidden="true"><path fill="#ccc" d="M16 4.588l2.833 8.719H28l-7.416 5.387 2.832 8.719L16 22.023l-7.417 5.389 2.833-8.719L4 13.307h9.167L16 4.588z"/></svg></button>
